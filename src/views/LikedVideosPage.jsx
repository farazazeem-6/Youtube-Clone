    ...
    <div className="p-6">
      <div className="flex items-center justify-between mb-6">
        ...
        <button
          ...
          className=" text-gray-600 px-4 py-2 rounded-lg text-sm  cursor-pointer transition-colors flex items-center gap-2"
        >
        ...
        {videosList.map((video) => (
          ...
          >
            ...
            <button
              ...
              className="shrink-0 text-gray-400 cursor-pointer  hover:text-gray-300 transition-colors p-2 flex items-center gap-1"
              title="Unlike video"
            >
